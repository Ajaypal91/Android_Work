package edu.sjsu.ajay.fitnessapp.Helper;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_ALL_TIME = "AllData";
     ...
     * @param stepData
     */
    public void insertStepData(Steps stepData) {
     ...
     */
    public List<Steps> getStepsData() {
        String selectQuery = "SELECT " + STEPS_TIMESTAMP + ", " + STEPS_COUNT + ", " + STEPS_CALORIES + " FROM " + TABLE_STEPS;
        SQLiteDatabase db  = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);

        List<Steps> data = new ArrayList<Steps>();
        if (cursor.moveToFirst()) {
            do {
                // get the data into array, or class variable
                Steps currData = new Steps();
     ...
     * @param allTimeData
     */
    public void insertAllTimeData(AllData allTimeData) {
        SQLiteDatabase db  = this.getReadableDatabase();
     ...
     * @param allTimeData
     */
    public void updateAllTimeData(AllData allTimeData) {
        SQLiteDatabase db  = this.getReadableDatabase();
